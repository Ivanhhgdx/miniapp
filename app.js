...
const teachersData = [
  {
    "name": "Шелихова Светлана Викторовна",
    "shortName": "Шелихова С. В.",
    "subjects": [
      "Иностранный язык"
    ],
  ...
  {
    "name": "Федченко Дмитрий Петрович",
    "shortName": "Федченко Д. П.",
    "subjects": [
      "Программирование"
    ],
    "department": "Не указана",
  ...
  {
    "name": "Осипов Владимир Владимирович",
    "shortName": "Осипов В. В.",
    "subjects": [
  ...
  {
    "name": "Логунова Ольга Викторовна",
    "shortName": "Логунова О. В.",
    "subjects": [
  ...
  {
    "name": "Летунова Ольга Владимировна",
    "shortName": "Летунова О. В.",
    "subjects": [
      "Философия"
    ],
    "department": "Не указана",
  ...
  {
    "name": "Карпов Евгений Сергеевич",
    "shortName": "Карпов Е. С.",
    "subjects": [
      "Программирование"
    ],
    "department": "Не указана",
    "position": "ассистент; младший научный сотрудник"
  },
  {
    "name": "Селиванова Анастасия Сергеевна",
    "shortName": "Селиванова А. С.",
    "subjects": [
      "Правоведение"
    ],
    "department": "Правоведения",
  ...
  {
    "name": "Самарин В. В.",
    "shortName": "Самарин В. В.",
    "subjects": [
      "Информационные системы в цифровой экономике"
    ],
    "department": "Не указана",
    "position": "Не указана"
  },
  ...
  {
    "name": "Кузнецов Александр Алексеевич",
    "shortName": "Кузнецов А. А.",
    "subjects": [
      "Аналитическая геометрия, линейная алгебра"
    ],
    "department": "Не указана",
    "position": "директор института; профессор"
  }
];

// Keep the official timetable text intact for daily synchronization.
function expandTeacherNames(text) {
  return teachersData.reduce((value, teacher) =>
    value.split(teacher.shortName).join(teacher.name), text);
}
