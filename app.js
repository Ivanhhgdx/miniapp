...
const teachersData = [
  ...
  },
  {
    ...
    subjects: ["Профессионально-прикладная физическая культура"],
    department: "Физического воспитания и спорта",
    position: "старший преподаватель",
  },
  {
    name: "Кубрикова Анна Сергеевна",
    subjects: ["Правоведение"],
    department: "Правоведения",
    position: "старший преподаватель",
  },
  {
    name: "Осипов В. В.",
    subjects: ["Аналитическая геометрия, линейная алгебра"],
    department: "Не указана",
    position: "преподаватель",
  },
  {
  ...
  {
    name: "Логунова О. В.",
    subjects: ["Психолого-педагогические технологии в профессиональной деятельности"],
    department: "Не указана",
    position: "преподаватель",
  },
  {
  ...
  },
  {
    ...
    subjects: ["Электричество и магнетизм", "Общий физический практикум"],
